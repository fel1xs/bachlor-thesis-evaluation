---
url: "https://www.wifa.uni-leipzig.de/institut-theoretische-vwl/professuren/makrooekonomik/studium/introduction-to-business-cycle-analysis-bsc"
title: "Universität Leipzig: Introduction to Business Cycle Analysis B.Sc."
---

Willkommen beim Modul „Introduction to Business Cycle Analysis B.Sc.“, das im Sommersemester angeboten wird.

Genauere Informationen finden Sie auf der englischsprachigen Seite des Moduls. Siehe Button oben rechts.
...
[mehr erfahren](http://www.uni-leipzig.de/ "zur Startseite der Universität Leipzig (Link öffnet neues Fenster)")

### Institut Theoretische VWL

[mehr erfahren](https://www.wifa.uni-leipzig.de/itvwl/startseite-des-instituts.html "Startseite Institut für Theoretische VWL (Link öffnet in neuem Fenster)")

### AlmaWeb

[mehr erfahren](https://almaweb.uni-leipzig.de/ "Startseite Almaweb (Link öffnet in neuem Fenster)")
